...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LBRAC
    | ID of (
# 4 "lib/traceparser.mly"
       (string)
# 20 "lib/traceparser.ml"
  )
    | FALSE
    | EOF
    | ELLIPSIS
...
# 1 "lib/traceparser.mly"
  

# 34 "lib/traceparser.ml"
...
let _menhir_action_01 =
  fun v x ->
    (
# 35 "lib/traceparser.mly"
                                      ([(x, v)])
# 87 "lib/traceparser.ml"
     : (Traceast.trace_state))

let _menhir_action_02 =
  fun t ->
    (
# 31 "lib/traceparser.mly"
                           (t)
# 95 "lib/traceparser.ml"
     : (Traceast.trace_state))

let _menhir_action_03 =
  fun t trest ->
    (
# 32 "lib/traceparser.mly"
                                                          (List.append t  trest)
# 103 "lib/traceparser.ml"
     : (Traceast.trace_state))

let _menhir_action_04 =
  fun () ->
    (
# 38 "lib/traceparser.mly"
               (true)
# 111 "lib/traceparser.ml"
     : (bool))

let _menhir_action_05 =
  fun () ->
    (
# 39 "lib/traceparser.mly"
                (false)
# 119 "lib/traceparser.ml"
     : (bool))

let _menhir_action_06 =
  fun () ->
    (
# 23 "lib/traceparser.mly"
                        ([])
# 127 "lib/traceparser.ml"
     : (Traceast.trace))

let _menhir_action_07 =
  fun t1 ->
    (
# 24 "lib/traceparser.mly"
                          ([t1])
# 135 "lib/traceparser.ml"
     : (Traceast.trace))

let _menhir_action_08 =
  fun t t1 ->
    (
# 25 "lib/traceparser.mly"
                                                      (t1 :: t)
# 143 "lib/traceparser.ml"
     : (Traceast.trace))

let _menhir_action_09 =
  fun t ->
    (
# 28 "lib/traceparser.mly"
                                             (t)
# 151 "lib/traceparser.ml"
     : (Traceast.trace_state))
