...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | IMPLY
    | ID of (
# 5 "corrected_version/ltlutils/lib/Parser.mly"
       (string)
# 26 "corrected_version/ltlutils/lib/Parser.ml"
  )
    | HISTORICALLY
    | GLOBALLY
    | FALSE
...
# 1 "corrected_version/ltlutils/lib/Parser.mly"
  
open Ast

# 44 "corrected_version/ltlutils/lib/Parser.ml"
...
let _menhir_action_01 =
  fun f ->
    (
# 40 "corrected_version/ltlutils/lib/Parser.mly"
                        ( f )
# 158 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_02 =
  fun () ->
    (
# 43 "corrected_version/ltlutils/lib/Parser.mly"
               ( LTrue )
# 166 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_03 =
  fun f ->
    (
# 44 "corrected_version/ltlutils/lib/Parser.mly"
                                    ( f )
# 174 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_04 =
  fun () ->
    (
# 45 "corrected_version/ltlutils/lib/Parser.mly"
                ( LFalse )
# 182 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_05 =
  fun x ->
    (
# 46 "corrected_version/ltlutils/lib/Parser.mly"
                 ( Identifier x )
# 190 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_06 =
  fun f ->
    (
# 47 "corrected_version/ltlutils/lib/Parser.mly"
                        ( Not f )
# 198 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_07 =
  fun f ->
    (
# 48 "corrected_version/ltlutils/lib/Parser.mly"
                              ( UnTOP(YESTERDAY, f) )
# 206 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_08 =
  fun f ->
    (
# 49 "corrected_version/ltlutils/lib/Parser.mly"
                             ( UnTOP(TOMORROW, f) )
# 214 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_09 =
  fun f ->
    (
# 50 "corrected_version/ltlutils/lib/Parser.mly"
                         ( UnTOP(ONCE, f) )
# 222 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_10 =
  fun f ->
    (
# 51 "corrected_version/ltlutils/lib/Parser.mly"
                               ( UnTOP(EVENTUALLY, f) )
# 230 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_11 =
  fun f ->
    (
# 52 "corrected_version/ltlutils/lib/Parser.mly"
                                 ( UnTOP(HISTORICALLY, f) )
# 238 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_12 =
  fun f ->
    (
# 53 "corrected_version/ltlutils/lib/Parser.mly"
                             ( UnTOP(GLOBALLY, f) )
# 246 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_13 =
  fun f1 f2 ->
    (
# 54 "corrected_version/ltlutils/lib/Parser.mly"
                                      ( BinTOP( SINCE, f1, f2) )
# 254 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_14 =
  fun f1 f2 ->
    (
# 55 "corrected_version/ltlutils/lib/Parser.mly"
                                      ( BinTOP(UNTIL, f1, f2) )
# 262 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_15 =
  fun f1 f2 ->
    (
# 56 "corrected_version/ltlutils/lib/Parser.mly"
                                    ( BinPOP(AND, f1, f2) )
# 270 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_16 =
  fun f1 f2 ->
    (
# 57 "corrected_version/ltlutils/lib/Parser.mly"
                                   ( BinPOP(OR, f1, f2) )
# 278 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_17 =
  fun f1 f2 ->
    (
# 58 "corrected_version/ltlutils/lib/Parser.mly"
                                      ( BinPOP(IMPLY, f1, f2) )
# 286 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))

let _menhir_action_18 =
  fun f1 f2 ->
    (
# 59 "corrected_version/ltlutils/lib/Parser.mly"
                                      ( BinPOP(EQUIV, f1, f2) )
# 294 "corrected_version/ltlutils/lib/Parser.ml"
     : (Ast.ltlformula))
